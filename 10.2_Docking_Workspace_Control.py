...
class WorkspaceControl(object):
    ...
    def set_label(self, label):
        return cmds.workspaceControl(self.name, q=True, label=label)
...
class SampleUI(QtWidgets.QWidget):
    ...
    def get_workspace_control_name(cls):
        return f"{cls.UI_NAME}WorkspaceControl"
    ...
    def create_workspace_control(self):
        ...
        if self.workspace_control_instance.exists():
            ...
            self.workspace_control_instance.create(self.WINDOW_TITLE, self, ui_script="from Pyside2_for_Maya.My_Dockable_button import SampleUI\nSampleUI.display()")
